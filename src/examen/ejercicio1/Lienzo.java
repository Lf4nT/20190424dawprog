...
public class Lienzo extends JPanel {
	...
	private static final BasicStroke solido = 
			new BasicStroke(3, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER);
	private static final BasicStroke discontinuo = 
			new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, patron, 0);
	...
	public boolean incFallos() {
		fallos++;
		repaint();
		return fallos == shapes.length;
	}
